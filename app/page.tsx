...
export default function Home() {
  ...
  async function createJob() {
    ...
    try {
      ...
      setMessage("Images uploaded and auto-named. Review before approving.");
    } catch (err) {
      ...
      <section style={{ maxWidth: 1180, margin: "0 auto" }}>
        ...
        >
          ...
          <p style={{ margin: 0, color: "#d1d5db", fontSize: 16 }}>
            Upload restaurant images, auto-name dishes, review, then approve for Phase B.
          </p>
        </div>
        ...
        >
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap", marginTop: 20 }}>
            ...
            >
              {loading ? "Uploading + Auto-naming..." : "Upload + Auto-name"}
            </button>
          ...
          {message && (
            <div style={notice("#ecfdf5", "#166534")}>{message}</div>
          )}

          {error && (
            <div style={notice("#fef2f2", "#991b1b")}>{error}</div>
          )}
        </div>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "end", gap: 16 }}>
              <div>
                ...
                <p style={{ margin: "8px 0 0", color: "#6b7280" }}>
                  Auto-names are editable. Remove bad images before approving.
                </p>
              </div>
