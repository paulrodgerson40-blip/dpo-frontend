...
const pricing = [
  {
    ...
    button: "Get Started",
    features: [
      "Professional food image enhancement",
      "Drinks included",
      "Store banners included",
      "Ready-to-upload image package",
      "Uber Eats & DoorDash optimized",
      "Priority turnaround",
    ],
  },
  {
  ...
  },
  {
    name: "Custom Quote",
    price: "Custom",
    detail: "50+ items / multi-location",
    button: "Contact Us",
    features: [
      "Large menu support",
      "Multi-location restaurants",
      "Custom banner requirements",
      "Priority processing",
      "Dedicated support",
      "Tailored delivery package",
    ],
  },
];
...
function LocalImage({
  ...
  const hasObjectFit = /\bobject-(cover|contain|fill|none|scale-down)\b/.test(
    className,
  );
  const finalClassName =
    `${hasObjectFit ? "" : "object-cover"} ${className}`.trim();
...
function Logo({ className = "" }: { className?: string }) {
  return (
    <div
      className={`relative h-20 w-[320px] sm:h-24 sm:w-[420px] ${className}`}
    >
      <Image
        src={ASSETS.logo}
        alt="Delivery Ignite"
...
function OrangeButton({
  ...
  return (
    ...
    >
      ...
      <span className="relative ml-2 transition group-hover:translate-x-1">
        →
      </span>
    </a>
  );
...
function EvidenceCard({
  ...
  return (
    <div className="group flex h-full min-h-[330px] flex-col rounded-[30px] border border-white/10 bg-black/28 p-6 shadow-[0_22px_80px_rgba(0,0,0,0.34)] transition duration-300 hover:border-cyan-300/22 hover:bg-white/[0.045]">
      ...
      <p className="mt-5 min-h-[126px] text-sm leading-7 text-white/72">
        {text}
      </p>
      ...
      <div className="mt-5 flex min-h-[58px] items-center justify-between gap-4">
        <div>
          ...
          <div className="mt-1 text-xs font-bold leading-5 text-cyan-100/75">
            {sourceSub}
          </div>
        </div>
...
function BeforeAfterCard({
  ...
  return (
    <div className="mx-3 w-[450px] shrink-0 rounded-[32px] border border-white/10 bg-white/[0.055] p-4 shadow-[0_24px_80px_rgba(0,0,0,0.38)] backdrop-blur">
      <div className="grid gap-3 sm:grid-cols-2">
        <div className="relative h-56 overflow-hidden rounded-2xl bg-black">
          <LocalImage
            src={before}
            alt={`${title} before`}
            className="object-contain saturate-[0.84] contrast-[0.92]"
            sizes="240px"
          />
      ...
      <div className="mt-4 text-xl font-black uppercase tracking-[-0.04em]">
        {title}
      </div>
...
const faqs = [
  ...
  {
    question: "Why not just use a cheap AI app?",
    answer:
      "Most AI apps produce inconsistent or unrealistic food images. Delivery Ignite focuses on realistic enhancement, menu consistency and premium delivery-platform presentation using your real food photos.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. Files are prepared for delivery apps, websites and social media. Each package is designed around delivery-platform presentation.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. Drinks and simple menu items are included as part of the complete delivery-menu package.",
  },
  {
    question: "How long does it take?",
    answer:
      "Most menus are completed within 24–72 hours depending on menu size and image quality.",
  },
  {
    question: "What do I receive?",
    answer:
      "You receive upgraded food images, ready-to-upload files, store banners, drink handling and before-and-after preview examples.",
  },
  {
...
export default function Page() {
  return (
    <main className="min-h-screen overflow-hidden bg-[#050505] text-white">
      ...
      <header className="sticky top-0 z-[100] border-b border-white/10 bg-black/76 backdrop-blur-2xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-8 px-5 py-6 sm:px-8 lg:px-10">
          ...
          <nav className="relative z-[101] hidden items-center gap-10 text-[11px] font-black uppercase tracking-[0.14em] text-white/55 md:flex">
            <a
              href="#proof"
              className="cursor-pointer transition hover:text-[#ff7a00]"
            >
              Proof
            </a>
            <a
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10 lg:py-20">
          <div className="max-w-[720px]">
            ...
            <p className="mt-7 max-w-xl text-lg leading-8 text-white/72">
              Premium delivery-menu upgrades designed to make your restaurant
              look cleaner, more professional and more worth ordering online.
            </p>
        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.72fr_1.28fr] lg:items-center">
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg leading-8 text-white/72">
              We work from your actual food photos. The dish stays recognisable
              — it just looks cleaner, fresher and more professional online.
            </p>
          ...
          <div className="relative h-[420px] overflow-hidden rounded-[42px] border border-white/12 bg-black shadow-[0_35px_130px_rgba(0,0,0,0.60),0_0_80px_rgba(34,211,238,0.12)]">
            <LocalImage
              src={ASSETS.spread}
              alt="Premium multi-cuisine food spread"
              className="scale-105"
            />
      ...
      <section
        id="menu"
        className="relative border-b border-white/10 bg-[#080808] px-5 py-20 sm:px-8 lg:px-10"
      >
        ...
        <div className="mx-auto max-w-[1500px]">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-white/60">
              Same food, same prices, same restaurant. The upgraded version
              simply looks cleaner, more trustworthy and easier to order from.
            </p>
          </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-5 text-5xl font-black uppercase leading-[0.86] tracking-[-0.075em] sm:text-7xl">
              From phone photos
              <span className="block text-[#ff7a00]">
                to a store that looks established.
              </span>
            </h2>
            <p className="mt-6 max-w-xl text-lg leading-8 text-white/72">
              We can also create storefront banners from your own food images,
              so the whole store feels more consistent and professional.
            </p>
          </div>
          ...
          <div className="grid gap-5">
            <div className="relative h-64 overflow-hidden rounded-[32px] border border-white/10 bg-black">
              <LocalImage
                ...
                className="object-contain"
              />
              <span className="absolute left-5 top-5 rounded-full bg-black/75 px-4 py-2 text-xs font-black uppercase tracking-[0.08em]">
                Before
              </span>
            </div>
            <div className="relative h-64 overflow-hidden rounded-[32px] border border-cyan-300/35 bg-black shadow-[0_0_70px_rgba(34,211,238,0.18)]">
              <LocalImage
                src={ASSETS.afterBanner}
                alt="After banner"
                className="object-contain"
              />
              <span className="absolute right-5 top-5 rounded-full bg-gradient-to-r from-[#ff5a00] to-[#ff9d20] px-4 py-2 text-xs font-black uppercase tracking-[0.08em] shadow-[0_0_18px_rgba(34,211,238,0.18)]">
                After
              </span>
            </div>
          </div>
      ...
      >
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-white/60">
              The goal is not fake AI food. The goal is to make your real menu
              look cleaner, more professional and more worth ordering.
            </p>
          </div>
      ...
      <section
        id="data"
        className="relative overflow-hidden border-b border-white/10 bg-[#050505] px-5 py-20 sm:px-8 lg:px-10"
      >
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h2 className="mt-5 text-5xl font-black uppercase leading-[0.86] tracking-[-0.075em] sm:text-6xl lg:text-7xl">
              ...
              <span className="block text-[#ff7a00]">
                Then your food does the rest.
              </span>
            </h2>
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-white/72">
              On delivery apps, customers decide quickly. Before they read the
              full menu, your photos tell them whether the food feels fresh,
              safe and worth ordering.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-5 lg:grid-cols-[0.95fr_1.05fr]">
            <div className="rounded-[34px] border border-cyan-300/24 bg-gradient-to-br from-cyan-400/[0.10] to-white/[0.035] p-7 shadow-[0_0_60px_rgba(34,211,238,0.10)]">
              ...
              <p className="mt-4 text-3xl font-black uppercase leading-[0.94] tracking-[-0.055em] text-white sm:text-4xl">
                ...
                <span className="block text-[#ff7a00]">
                  They make the restaurant feel safer, cleaner and more
                  valuable.
                </span>
              </p>
            </div>
            ...
            <div className="rounded-[34px] border border-cyan-300/24 bg-gradient-to-br from-white/[0.055] to-cyan-400/[0.08] p-7 shadow-[0_0_60px_rgba(34,211,238,0.10)]">
              ...
              <p className="mt-4 text-3xl font-black uppercase leading-[0.94] tracking-[-0.055em] text-white sm:text-4xl">
                ...
                <span className="block text-[#ff7a00]">
                  Better-looking menus win attention first.
                </span>
              </p>
            </div>
          </div>
          ...
          <div className="mt-10 rounded-[40px] border border-cyan-300/24 bg-gradient-to-br from-cyan-400/[0.08] via-white/[0.035] to-black/20 p-6 shadow-[0_0_70px_rgba(34,211,238,0.08),0_30px_110px_rgba(0,0,0,0.45)] sm:p-8">
            <div className="flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
              ...
              <p className="max-w-md text-sm leading-7 text-white/58">
                Real research and platform guidance point to the same thing:
                customers judge quickly, visuals shape trust, and food photos
                need to look clear, accurate and appetising.
              </p>
            </div>
      ...
      <section className="bg-[#070707] px-5 py-20 sm:px-8 lg:px-10">
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
            ...
            <p className="max-w-md text-white/55">
              Real feedback can be added here as pilot jobs come in. For now,
              keep the wording plain and believable.
            </p>
          </div>
        </div>
        ...
        <div className="mt-12 overflow-hidden">
          <div className="di-marquee-right flex w-max">
            {[
              [
                "Our menu finally looks like the food we actually serve.",
                "Restaurant owner",
                "Burger shop · Melbourne",
              ],
              [
                "The before and after made the choice easy.",
                "Operator",
                "Asian restaurant · VIC",
              ],
              [
                "The store looked much cleaner straight away.",
                "Manager",
                "Cafe · South East Melbourne",
              ],
              [
                "Same food, but the menu looks way more professional.",
                "Owner",
                "Pizza store · Melbourne",
              ],
              [
                "Our menu finally looks like the food we actually serve.",
                "Restaurant owner",
      ...
      <section
        id="pricing"
        className="relative border-y border-white/10 bg-[#0b0b0b] px-5 py-20 sm:px-8 lg:px-10"
      >
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 text-5xl font-black uppercase leading-[0.86] tracking-[-0.075em] sm:text-7xl">
              Premium delivery-menu transformation.
              <span className="block text-[#ff7a00]">
                Built for modern restaurants.
              </span>
            </h2>
            <p className="mx-auto mt-5 max-w-2xl text-white/55">
              Professional menu enhancement for restaurants that want cleaner,
              more premium delivery-app presentation.
            </p>
          ...
          <div className="mt-12 grid gap-5 lg:grid-cols-3">
            {pricing.map((plan) => (
              ...
              >
                ...
                <h3 className="min-h-[34px] text-2xl font-black tracking-[-0.03em] text-white">
                  {plan.name}
                </h3>
                <p className="mt-4 min-h-[78px] text-sm leading-6 text-white/55">
                  For restaurants that want their menu to look cleaner, more
                  professional and more worth ordering.
                </p>
                <div className="mt-5 min-h-[78px]">
                  <div className="text-5xl font-black tracking-[-0.05em]">
                    {plan.price}{" "}
                    <span className="text-base text-white/45">+ GST</span>
                  </div>
      ...
      <section
        id="contact"
        className="relative overflow-hidden border-t border-white/10 bg-[#050505] px-5 py-20 sm:px-8 lg:px-10"
      >
          ...
          <div className="rounded-[42px] border border-cyan-300/22 bg-gradient-to-br from-cyan-400/[0.09] via-white/[0.035] to-black/20 p-8 shadow-[0_0_70px_rgba(34,211,238,0.08),0_30px_110px_rgba(0,0,0,0.45)] sm:p-10">
            <div className="max-w-3xl">
              ...
              <h2 className="mt-5 text-5xl font-black uppercase leading-[0.86] tracking-[-0.075em] sm:text-7xl">
                ...
                <span className="block text-[#ff7a00]">
                  See how premium your menu can look.
                </span>
              </h2>
              <p className="mt-6 max-w-2xl text-lg leading-8 text-white/72">
                Tell us your restaurant name and which platform you use — Uber
                Eats, DoorDash or both — and we’ll create 3 enhanced sample
                photos so you can see how much stronger your menu could look
      ...
      <section
        id="faq"
        className="relative border-t border-white/10 bg-[#070707] px-5 py-20 sm:px-8 lg:px-10"
      >
        ...
        <div className="relative mx-auto max-w-5xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-white/58">
              Simple answers for restaurant owners who want better menu photos
      ...
      <section
        id="sample"
        className="relative overflow-hidden border-t border-white/10 bg-black px-5 py-14 text-center sm:px-8 lg:px-10"
      >
        ...
        <div className="relative mx-auto max-w-3xl overflow-hidden rounded-[38px] border border-cyan-300/26 bg-white/[0.055] p-8 shadow-[0_0_78px_rgba(34,211,238,0.14)] backdrop-blur-xl sm:p-10">
          <h2 className="relative text-5xl font-black uppercase leading-[0.86] tracking-[-0.075em] sm:text-6xl">
            ...
            <span className="text-[#ff7a00]">look worth ordering?</span>
          </h2>
          <p className="relative mx-auto mt-5 max-w-xl text-white/60">
            Start with 3 free sample images and see the difference before you
            commit.
          </p>
      ...
      <footer className="border-t border-white/10 bg-black px-5 py-10 sm:px-8 lg:px-10">
        <div className="mx-auto grid max-w-7xl gap-8 text-center sm:text-left lg:grid-cols-[1.2fr_0.8fr_0.8fr]">
          <div>
            ...
            <div className="mt-2 max-w-sm text-sm leading-6 text-white/42">
              Premium restaurant visual upgrades built for Uber Eats, DoorDash,
              websites and modern delivery brands.
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-3 flex flex-col gap-2 text-sm font-bold text-white/50">
              <a href="#pricing" className="transition hover:text-[#ff7a00]">
                Pricing
              </a>
              <a href="#faq" className="transition hover:text-[#ff7a00]">
                FAQ
              </a>
        ...
        <div className="mx-auto mt-8 max-w-7xl border-t border-white/10 pt-5 text-center text-xs text-white/30 sm:text-left">
          © 2026 Delivery Ignite. All prices exclude GST unless stated
          otherwise.
        </div>
      </footer>
    </main>
